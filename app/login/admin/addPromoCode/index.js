...
import './addPromoCode.less'

export default class addPromoCodeComponent extends Component {
    static defaultProps = {
        prefixCls: 'addPromoCode'
    }
        ...
        return (
            <div className={this.props.prefixCls}>
                <div className={`${prefixCls}-body`}>
                    <DynamicComponent {...otherProps} _path="addPromoCode"/>
                </div>
                {Modal(message)}
            </div>
        )
