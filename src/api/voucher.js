 ...
 * @returns {*}
 */
export function getSaleDocId(post, filters) {
    return post('/v1/journal/getSaleDocId', filters || {})
}
...
export function del(post, params) {
    return post('/v1/journal/delete', params)
}
 ...
 * @param accountId
 */
export function getAccountBalance(post, list) {
    return post('/v1/journal/getAccountBalance', list)
}
 ...
 * {}
 */
export function getDocPrintConfig(post){
    return post('/v1/journal/getDocPrintConfig')
}
...
* @param  {[type]} formPost [description]
* @param  {[type]}
* list: {"inAccountDate":"2018-07", "status":1,//0,1,2  “docId”:1, “orgId”:1, "page":{"currentPage":1,"pageSize":4}}
* @param  {[type]} token  [description]
*/
export function queryBypage(post,list) {
    return post('/v1/bill/queryByPage',list)
}
...
* @param  {[type]} formPost [description]
* @param  {[type]}
* list: [552, 5512] 数据ID集合
* @param  {[type]} token  [description]
*/
export function batchDelete(post, list) {
    return post('/v1/bill/batchDelete', list)
}
...
* @param  {[type]} formPost [description]
* @param  {[type]}
* list: {"currentYear":2017,"currentPeriod":1}
* @param  {[type]} token  [description]
*/
export function queryDocListByDate(post, list) {
    return post('/v1/journal/queryDocListByDate', list)
}
...
* @param  {[type]} token  [description]
*/
export function queryByDoc(post, list) {
    return post('/v1/bill/queryByDoc', list)
}

/**
* 补充或新增增值税信息 init下拉数据 查询
* @param  {[type]} formPost [description]
* @param  {[type]}
* list: {"docId":100}
* @param  {[type]} token  [description]
*/
export function judgeBusinessTypeByDocId(post, list) {
    return post('/v1/journal/judgeBusinessTypeByDocId', list)
}
...
* @param  {[type]} token  [description]
*/
export function saveOrUpdate(post, list) {
    return post('/v1/bill/saveOrUpdate', list)
}
