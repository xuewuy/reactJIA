...
var FixedDataTableCell = React.createClass({
  ...
  propTypes_DISABLED_FOR_PERFORMANCE: {
    ...
    calculateState: function calculateState(props){
        if(!props._getter || !props._path || !props.columnKey || props.columnKey.indexOf('endOptionColumn') !== -1) return {}
    ...
    shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState) {
        if(this.props.rowIndex !== nextProps.rowIndex || 
            ...
            (nextProps._mustRender !== undefined && nextProps._mustRender == true)
            ) {
            return true
        }
